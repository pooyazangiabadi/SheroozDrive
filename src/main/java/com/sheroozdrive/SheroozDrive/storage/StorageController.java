package com.sheroozdrive.SheroozDrive.storage;

import com.sheroozdrive.SheroozDrive.storage.exceptions.TusBadRequestException;
import com.sheroozdrive.SheroozDrive.storage.exceptions.TusDBFileNotFoundException;
import com.sheroozdrive.SheroozDrive.storage.model.TusFile;
import com.sheroozdrive.SheroozDrive.storage.model.TusFilesRepository;
import com.sheroozdrive.SheroozDrive.storage.services.StorageService;
...
@CrossOrigin(origins = "*", maxAge = 3600,exposedHeaders = { "Upload-Length", "Tus-Resumable", "Upload-Metadata"})
@RestController
@RequestMapping("/tus")
public class StorageController {
    ...
    ResponseEntity<?> processOptionsUuid(@PathVariable String uuid, HttpServletResponse response) throws Exception {
        ...
        TusFile file = repo.findById(uuid).orElseThrow(()->new TusDBFileNotFoundException(uuid));
